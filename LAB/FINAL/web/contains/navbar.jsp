...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<% out.print(Guide.getRoute(request, "dashboard"));%>">#COLLECT.project</a>
        </div>
                ...
                <li class="dropdown">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false">Welcome, <%out.print(session.getAttribute("th_name")); %> <span
                            class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="<% out.print(Guide.getRoute(request, "dashboard")); %>">Dashboard</a></li>
                        <li><a href="<% out.print(Guide.getRoute(request, "account")); %>">Profile</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="logout">Logout</a></li>
                    </ul>
